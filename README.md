...
- :launcher (Android application)
  ...
  - Entry point Activity: io.engst.launcher.LauncherActivity
  - Depends on :core
  - Compose UI with adaptive layout hints (ScreenConfig)
...
- :devicetool (Android application; internal/debug)
  ...
  - Entry point Activity: com.example.playground.DeviceToolInternalActivity
...
- For Compose/adaptive layout logic (e.g., ScreenConfig), prefer extracting pure functions for unit tests.
...
├─ launcher/
│  ├─ build.gradle.kts
│  ├─ src/main/java/io/engst/launcher/LauncherActivity.kt (entry point)
│  ├─ src/main/java/io/engst/launcher/ScreenConfig.kt (adaptive layout logic)
│  └─ src/test/java/io/engst/launcher/ExampleUnitTest.kt
├─ core/
│  ├─ build.gradle.kts
│  ├─ src/main/java/io/engst/core/Logger.kt
│  ├─ src/main/java/io/engst/core/LaunchApps.kt
│  └─ src/test/java/io/engst/core/ExampleUnitTest.kt
├─ devicetool/
│  ├─ build.gradle.kts
│  ├─ src/main/java/com/example/playground/DeviceToolInternalActivity.kt (entry point)
│  └─ src/main/java/com/example/playground/DeviceInfo.kt
