...
- longpress of an empty cell or elsewhere should show the settings menu
...
Add tests to verify all of these aspects. Use robolectric to verify Compose Gesture detection.